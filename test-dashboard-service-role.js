...
// Use service role key to test dashboard queries (bypasses RLS)
const supabase = createClient(supabaseUrl, supabaseServiceKey);

async function testDashboardWithServiceRole() {
  console.log(
    "🔧 Testing dashboard queries with service role (bypasses RLS)..."
  );
  ...
  try {
    ...
    console.log("\n🎉 Service role dashboard queries completed!");
    console.log(
      "📋 If these work but anon key fails, RLS is still enabled on dashboard tables"
    );
  } catch (error) {
