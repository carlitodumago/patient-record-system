...
:root {
  ...
  --gradient-medical: linear-gradient(135deg, #2563eb 0%, #059669 100%);
  --shadow-floating: 0 5px 15px -3px rgba(0, 0, 0, 0.1),
  ...
  --admin-secondary-light: #10b981;
  --admin-secondary-dark: #047857;
